...
<nav class="navbar navbar-expand-lg bg-body-tertiary ">
  <div class="container">
    <a class="navbar-brand" href="index.html"><img src="{{ asset('img/logo.png') }}" alt="" style="width: 150px;"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
     ...
     <span class=" text-white btn btn-danger mb-3 " style="width: 20px; height: 20px; font-size: 10px; text-decoration:  none; padding: 5px;">{{ count($cart) ?? 0 }}</span>
      </a>
