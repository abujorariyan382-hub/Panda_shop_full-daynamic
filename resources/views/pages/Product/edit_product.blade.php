...
<main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit page of product</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.page') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Edit product</li>
                        </ol>

                            <form action="{{ route('update.product.page',$product->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row align-items-center">
                                    ...
                                    <div class="input-group mt-3">
                                        ...
                                        <select name="catagory" class="form-select" id="inputGroupSelect02">
                                            @foreach ($catagorys as $catagory)
                                                <option value="{{$catagory->add_catagory}}" @if($product->catagory == $catagory->add_catagory) selected @endif>{{$catagory->add_catagory}}</option>
                                            @endforeach
                                ...
                                <div class="col-md-3">
                                     <div>
                                        <h3>Product image</h3>
                                         <img style="height: 30vh" src="{{ asset('storage/' . $product->product_image) }}" class="img-thumbnail" id="prevImage" >
